  ...
  */
  ...
  function usePopper(referenceElement, popperElement, _temp) {
    var _ref3 = _temp === void 0 ? {} : _temp,
      ...
      config = _objectWithoutPropertiesLoose$1(_ref3, [
        'enabled',
        'placement',
        'strategy',
        'modifiers',
  ...
  var Overlay = /*#__PURE__*/ React__default.forwardRef(function(
    ...
    var _usePopper = usePopper(
      ...
      popper = _objectWithoutPropertiesLoose$1(_usePopper, [
        'styles',
        'attributes',
      ])
  ...
  Overlay.propTypes = {
    ...
    onHide: function onHide(props) {
      ...
      if (props.rootClose) {
        ...
        return (_PropTypes$func = propTypes$1.func).isRequired.apply(
          _PropTypes$func,
          [props].concat(args)
        )
      }
  ...
  function classList(props) {
    ...
    _defineProperty$1(_classes, 'fa-swap-opacity', props.swapOpacity),
  ...
  function convert(createElement, element) {
    ...
    return createElement.apply(
      void 0,
      [element.tag, _objectSpread2({}, mixins.attrs, {}, remaining)].concat(
  ...
  function FontAwesomeIcon(_ref) {
    ...
    var classes = objectWithKey(
      'classes',
      [].concat(
        _toConsumableArray(classList(props)),
        _toConsumableArray(className.split(' '))
      )
    )
    ...
    var renderedIcon = icon(
      iconLookup,
      _objectSpread2({}, classes, {}, transform, {}, mask, {
        symbol: symbol,
        title: title,
        titleId: titleId,
      })
