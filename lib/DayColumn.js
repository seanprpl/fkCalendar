...
function (_React$Component) {
  ...
  _proto.render = function render() {
    var _this$props3 = this.props,
        ...
        getters = (0, _objectWithoutPropertiesLoose2.default)(_this$props3$getters, _excluded),
        _this$props3$componen = _this$props3.components,
        EventContainer = _this$props3$componen.eventContainerWrapper,
        components = (0, _objectWithoutPropertiesLoose2.default)(_this$props3$componen, _excluded2);
    ...
    return (
      /*#__PURE__*/
      _react.default.createElement(DayColumnWrapperComponent, {
        date: date,
        style: style,
        ...
        return (
          /*#__PURE__*/
          _react.default.createElement(_TimeSlotGroup.default, {
            key: idx,
            group: grp,
            resource: resource,
            getters: getters,
      ...
      /*#__PURE__*/
      _react.default.createElement("span", null, localizer.format(selectDates, 'selectRangeFormat'))), isNow && this.intervalTriggered &&
      /*#__PURE__*/
      _react.default.createElement("div", {
